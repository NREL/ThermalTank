...
class TestSimpleIceTank(unittest.TestCase):
    ...
    def test_calculate(self):
        ...
        self.assertAlmostEqual(tank.tank_temp, 0.57, delta=0.01)
        self.assertAlmostEqual(tank.ice_mass, 0, delta=0.1)
